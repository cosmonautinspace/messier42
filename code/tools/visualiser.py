...
rb_train_losses = np.loadtxt("code/ann_PyBrain/rb_train_losses.csv", delimiter=",")
rb_test_losses = np.loadtxt("code/ann_PyBrain/rb_test_losses.csv", delimiter=",")
g_train_losses = np.loadtxt("code/ann_PyBrain/g_train_losses.csv", delimiter=",")
g_test_losses = np.loadtxt("code/ann_PyBrain/g_test_losses.csv", delimiter=",")

rb_residuals = np.loadtxt("code/ols/rb_ols_residuals.csv", delimiter=",")
g_residuals = np.loadtxt("code/ols/g_ols_residuals.csv", delimiter=",")
...
plt.savefig("residual_diagnostic_plots.png")
...
plt.savefig("residual_scatter_plots.png")
