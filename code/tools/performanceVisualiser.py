...
plt.savefig('documentation/visualizations/ANN_green_performance.png')
plt.close()
...
plt.savefig('documentation/visualizations/ANN_red_performance.png')
plt.close()
...
plt.savefig('documentation/visualizations/ANN_blue_performance.png')
plt.close()